...
local tagGroupLabel = "movement/tag"
...
os.getenv("HOME"), chosen_theme) beautiful.init(theme_path)
...
--menubar.utils.terminal = terminal -- Set the Menubar terminal for applications
--that require it 
...
globalkeys = my_table.join(
  ...
  {description = "show dmenu", group = "lauchers"}),
    ...
    --awful.key({ modkey,"Shift" }, "e",  function () awful.util.spawn( "arcolinux-logout" ) end,
    ...
    awful.key({ modkey }, "r", function() awful.util.spawn( "xfce4-appfinder" ) end,
        {description = "Xfce appfinder", group = "lauchers"}),
    ...
    --awful.key({ modkey,"Shift"}, "Left",   awful.tag.viewprev,
        --{description = "view previous", group = tagGroupLabel}),
    --awful.key({ modkey, "Shift"}, "Right",  awful.tag.viewnext,
        --{description = "view next", group = tagGroupLabel}),

    awful.key({ modkey,}, "Tab", awful.tag.history.restore,
        {description = "go back", group = tagGroupLabel}),


    -- Non-empty tag browsing
    awful.key({ modkey }, "Left", function () 
      lain.util.tag_view_nonempty(-1) end,
              {description = "view  previous nonempty", group = tagGroupLabel}),
    ...
    awful.key({ modkey }, "j", function()
        ...
        {description = "focus down", group = clientGroupLabel}),
    awful.key({ modkey }, "k",
        function()
            awful.client.focus.global_bydirection("up")
            if client.focus then client.focus:raise() end
        end,
        {description = "focus up", group = clientGroupLabel}),
    awful.key({ modkey }, "h",
        function()
            awful.client.focus.global_bydirection("left")
            if client.focus then client.focus:raise() end
        end,
        {description = "focus left", group = clientGroupLabel}),
    awful.key({ modkey }, "l",
        function()
            awful.client.focus.global_bydirection("right")
            if client.focus then client.focus:raise() end
        end,
        {description = "focus right", group = clientGroupLabel}),


    -- Layout manipulation
    awful.key({ modkey, "Shift"}, "j", function () 
      awful.client.swap.byidx(  1) end,
        {description = "swap with next client by index", group = clientGroupLabel}),
    awful.key({ modkey, "Shift"   }, "k", function () 
      awful.client.swap.byidx( -1) end,
        {description = "swap with previous client by index", group = clientGroupLabel}),
 ...
 -- Show/Hide Systray
    ...
    awful.key({ modkey, "Shift" }, "n", function () lain.util.add_tag() end,
              {description = "add new tag", group = tagGroupLabel}),
    awful.key({ modkey, "Control" }, "r", function () lain.util.rename_tag() end,
              {description = "rename tag", group = tagGroupLabel}),
    awful.key({ modkey, "Shift" }, "Left", function () lain.util.move_tag(-1) end,
              {description = "move tag to the left", group = tagGroupLabel}),
    awful.key({ modkey, "Shift" }, "Right", function () lain.util.move_tag(1) end,
              {description = "move tag to the right", group = tagGroupLabel}),
    awful.key({ modkey, "Shift" }, "y", function () lain.util.delete_tag() end,
              {description = "delete tag", group = tagGroupLabel}),

    awful.key({ modkey, altkey}, "l", function () 
      awful.tag.incmwfact( 0.05) end,
        {description = "increase master width factor", group = clientGroupLabel}),
    awful.key({ modkey, altkey}, "h", function () 
      awful.tag.incmwfact(-0.05) end,
        {description = "decrease master width factor", group = clientGroupLabel}),
    ...
    awful.key({ modkey,}, "space", function () 
      awful.layout.inc( 1)  end,
        {description = "select next", group = clientGroupLabel}),
    ...
    {description = "restore minimized", group = clientGroupLabel}),

    -- Widgets popups
    --awful.key({ altkey, }, "c", function () lain.widget.calendar.show(7) end,
        --{description = "show calendar", group = "widgets"}),
    --awful.key({ altkey, }, "h", function () if beautiful.fs then
      --beautiful.fs.show(7) end end, {description = "show filesystem", 
      --group = "widgets"}),
    --awful.key({ altkey, }, "w", function () if beautiful.weather then 
      --beautiful.weather.show(7) end end, {description = "show weather", 
      --group = "widgets"}),
...
clientkeys = my_table.join(
    ...
    awful.key({ modkey,}, "f",
        ...
        {description = "toggle fullscreen", group = clientGroupLabel}),
    ...
    awful.key({ modkey, "Shift" }, "space",  awful.client.floating.toggle,
              {description = "toggle floating", group = clientGroupLabel}),

    --awful.key({ modkey, "Control" }, "Return", 
      --function (c) c:swap(awful.client.getmaster()) end,
              --{description = "move to master", group = clientGroupLabel}),
    ...
    awful.key({ modkey }, "n",
        function (c)
            ...
            c.minimized = true
        end , {description = "minimize", group = clientGroupLabel}),
    awful.key({ modkey, }, "m",
        function (c)
            c.maximized = not c.maximized
            c:raise()
        end ,
        {description = "maximize", group = clientGroupLabel})
)
...
for i = 1, 9 do
    ...
    if i == 1 or i == 9 then
        descr_view = {description = "view tag #", group = tagGroupLabel}
        descr_toggle = {description = "toggle tag #", group = tagGroupLabel}
        descr_move = {description = "move focused client to tag #", group = tagGroupLabel}
